...
def weather_tool(city: str) -> str:
    """Returns the current weather for a city using Open-Meteo API."""
    city_coords = {
...
async def get_agents():
    ...
    # Sequential agent: echo_agent then math_agent
    echo_agent = LlmAgent(
        name="echo_agent",
    ...
    # Parallel agent: echo_agent_parallel and current_time_agent_parallel
...
if __name__ == "__main__":
    ...
    print("\n--- Weather Tool Test ---")
    asyncio.run(main("What is the weather in Paris?", agent_type="root"))
